...
Strings = {
    ['start_heist'] = 'Kliknij ~INPUT_CONTEXT~ aby wystartowac napad na Jubilera',
    ['goto_vangelico'] = 'Udaj sie na dach Jubilera. Rzuc bombe gazowa w miejsce, ktore masz oznaczone na zolto. Zakup: Maske gazowa, Narzedzie do ciecia i scyzoryk.',
    ['wait_nextrob'] = 'Musisz zaczekac przed ponownym obrabowaniem',
    ['minute'] = 'Minuta.',
    ['start_stealing'] = 'Kliknij ~INPUT_CONTEXT~ aby obrabowac',
    ['cute_right'] = 'Kliknij ~INPUT_CONTEXT~ aby ciac w prawo',
    ['cute_left'] = 'Kliknij ~INPUT_CONTEXT~ aby ciac w lewo',
    ['cute_down'] = 'Kliknij ~INPUT_CONTEXT~ aby ciac w dol',
    ['glass_cut'] = 'Kliknij ~INPUT_CONTEXT~ aby wyrwac szybke',
    ['smash'] = 'Kliknij ~INPUT_CONTEXT~ aby zbic szybke',
    ['throw_gas_blip'] = 'Rzuc gaz',
    ['good_shot'] = 'Dobry strzal! Wejdz do Jubilera, nie zapomnij o Masce Gazowej!',
    ['need_switchblade'] = 'Potrzebujesz scyzorka.',
    ['need_rifle'] = 'Potrzebujesz pistoletu.',
    ['need_this'] = 'Potrzebujesz: ',
    ['deliver_to_buyer'] = 'Dostarcz przedmioty do kupujacego. Zobacz GPS.',
    ['buyer_blip'] = 'Dostarcz przedmioty',
    ['need_police'] = 'Zbyt malo LSPD na miescie.',
    ['total_money'] = 'Masz to: ',
    ['police_alert'] = 'Ktos wlamal sie do Jubilera! Zobacz GPS.',
}
